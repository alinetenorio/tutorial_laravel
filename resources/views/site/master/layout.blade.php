...
<head>
    ...
    <!--<link rel="stylesheet" href="http://localhost/aline/laravel/tutorial/public/css/style.css">-->
  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item {{ (Route::current()->getName() === 'site.cursos' ? 'active' : '' ) }}">
          <a class="nav-link" href="{{ route('site.cursos') }}">Cursos</a>
        </li>
        <li class="nav-item {{ (Route::current()->getName() === 'site.contato' ? 'active' : '' ) }}">
          <a class="nav-link" href="{{ route('site.contato') }}">Contato<span class="sr-only">(current)</span></a>
        </li>
      </ul>
